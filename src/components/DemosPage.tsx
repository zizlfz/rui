...
import {
	ListBox,
	ListBoxItem as ListBoxDropdownItem,
...
import { SelectWithTagGroup } from "#/components/ui/SelectWithTagGroup";
import {
	SkeletonCircle,
	SkeletonRect,
	SkeletonText,
				...
				<div className="container min-h-full">
					<div className="border-l border-r min-h-full bg-border">
						<div className="grid lg:grid-cols-2 xl:grid-cols-3 gap-px">
							...
							<DemoBox componentName="RangeCalendar">
								<RangeCalendarDemo />
							</DemoBox>
							...
							<DemoBox componentName="CheckboxGroup">
								<CheckboxGroupDemo />
							</DemoBox>
							...
							<DemoBox componentName="Input">
								<div className="flex flex-col gap-2" style={{ width: "200px" }}>
									<Input label="Text field" placeholder="Enter text" />
								</div>
							</DemoBox>
							<DemoBox componentName="ListBox">
								<ListBoxDemo />
							</DemoBox>
							...
							<DemoBox componentName="SelectWithTagGroup">
								<SelectWithTagGroupDemo />
							</DemoBox>
							...
							<DemoBox componentName="Textarea" to="/ui/Input">
								<div className="flex flex-col gap-2" style={{ width: "200px" }}>
									<TextArea
										label="With label"
										placeholder="Write something..."
									/>
									<TextArea value="This is invalid" isInvalid />
								</div>
							</DemoBox>
...
function CheckboxGroupDemo() {
	return (
		<div className="flex flex-col gap-4">
			...
			<CheckboxGroup label="Disabled" isDisabled>
...
function DatepickerDemo() {
	...
	return <DatePicker label="With value" value={date} onChange={setDate} />;
}
...
function DateFieldDemo() {
	...
	return (
		<div className="flex flex-col gap-4">
			<DateField label="Birth Date" defaultValue={parseDate("2025-02-03")}>
		...
		<div className="flex flex-col gap-4 pb-32 pr-10">
			<DropdownTrigger>
				...
				<Dropdown>
					...
					<DropdownItem
						id="delete"
						style={{ color: "var(--color-surface-destructive)" }}
					>
						Delete
					</DropdownItem>
				</Dropdown>
		...
		<DialogTrigger>
			...
			<Modal isDismissable>
				...
				<Form className="flex flex-col gap-3">
					<Input label="Name" autoFocus placeholder="Enter your full name" />
	...
	return (
		<div className="flex flex-col gap-6">
			...
			<TagGroup
				...
				renderEmptyState={() => (
					<div className="text-content-muted text-sm">No tags</div>
				)}
			>
...
function SelectWithTagGroupDemo() {
...
function ListBoxDemo() {
	...
	return (
		...
		>
			{(item) => (
				<ListBoxDropdownItem id={item.id}>{item.name}</ListBoxDropdownItem>
			)}
		</ListBox>
	);
}
